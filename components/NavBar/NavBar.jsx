    ...
    return (
      <div className={styles.top}>
        <div className={styles.container}>
          ...
          <NavLink title="Fun" active={this.props.selected == "Fun"} handleClick={this.props.handleFun}/>
          <NavLink title="Work" active={this.props.selected == "Work"} handleClick={this.props.handleWork}/>
          <NavLink title="About" active={this.props.selected == "About"} handleClick={this.props.handleAbout}/>
          <NavLink title="Home" active={this.props.selected == "Home"} handleClick={this.props.handleHome}/>
