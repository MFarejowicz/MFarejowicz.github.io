  ...
  render() {
    ...
    return (
      <div>
        ...
        <hr/>
        <Timeline>
          <TimelineEvent title="18.600: Probability Grader" createdAt="February 2019 - May 2019" iconColor="#f17e33" icon={<img src="./static/img/grade.png" width="52%"></img>}>
          ...
          <TimelineEvent title="18.06 Grader/6.009 Lab Assistant" createdAt="September 2018 - December 2018" iconColor="#f17e33" icon={<img src="./static/img/keyboard.png" width="52%"></img>}>
          ...
          <TimelineEvent title="18.06: Linear Algebra Grader" createdAt="February 2018 - May 2018" iconColor="#f17e33" icon={<img src="./static/img/grade.png" width="52%"></img>}>
          ...
          <TimelineEvent title="18.02 Calculus Grader" createdAt="October 2017 - December 2017" iconColor="#f17e33" icon={<img src="./static/img/grade.png" width="52%"></img>}>
          ...
          <TimelineEvent title="8.02: Physics TA" createdAt="February 2017 - May 2017" iconColor="#f17e33" icon={<img src="./static/img/phys.svg" width="50%"></img>}>
