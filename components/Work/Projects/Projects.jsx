        ...
        <div className={styles.container}>
          <div className={styles.project}>
            ...
            >
              <img
                ...
                src="./static/img/tstyper.png"
                alt="tstyper"
              ></img>
              <div className={styles.projectInfo}>
                <h3 className={styles.title}>TS Typer</h3>
                <p className={styles.caption}>
                  Game made to practice using React with Typescript.
                </p>
              </div>
            </a>
          </div>
          <div className={styles.project}>
            <a href="http://sound-space.herokuapp.com/" className={styles.link}>
              ...
              <div className={styles.projectInfo}>
                ...
                <p className={styles.caption}>
                  Worked with Joonho Ko during web.lab to produce a web app
                  about creating sounds with friends or stangers.
                </p>
              </div>
            </a>
          </div>
          <div className={styles.project}>
            <a href="https://mcd4-me.web.app/" className={styles.link}>
              <img
                className={styles.picture}
                src="./static/img/mcd.png"
                alt="McD4Me"
              ></img>
              <div className={styles.projectInfo}>
                <h3 className={styles.title}>McD4Me</h3>
                <p className={styles.caption}>
                  Created a food order consolidation web app that uses Google's
                  Firebase technology.
                </p>
              </div>
            </a>
          ...
          <div className={styles.project}>
            <a href="https://next.mit.edu/nextgamers" className={styles.link}>
              ...
              <div className={styles.projectInfo}>
                ...
                <p className={styles.caption}>
                  Designed and built a website for a student group within my
                  dorm, Next Gamers.
                </p>
              </div>
            </a>
          ...
          <div className={styles.project}>
            <a href="http://music.2east.us" className={styles.link}>
              <img
                className={styles.picture}
                src="./static/img/muse.png"
                alt="2GroovE"
              ></img>
              <div className={styles.projectInfo}>
                <h3 className={styles.title}>2E GroovE</h3>
                <p className={styles.caption}>
                  Co-built a web app with Cory Lynch which queues and plays
                  music into the 2E Main Lounge. Currently maintained by Michael
                  Nguyen.
                </p>
              </div>
            </a>
          ...
          <div className={styles.project}>
            <a href="https://next2e.github.io/" className={styles.link}>
              <img
                className={styles.picture}
                src="./static/img/2e.png"
                alt="Next 2E"
              ></img>
              <div className={styles.projectInfo}>
                <h3 className={styles.title}>Next 2E Website</h3>
                <p className={styles.caption}>
                  Primary contributor to the website for my wing within Next
                  House, 2E.
                </p>
              </div>
            </a>
          ...
          <div className={styles.project}>
            ...
            >
              ...
              <div className={styles.projectInfo}>
                ...
                <p className={styles.caption}>
                  {" "}
                  Another example website for Replot, made using data I
                  collected concerning DotA 2, a popular E-Sport.{" "}
                </p>
              </div>
            </a>
          </div>
          <div className={styles.project}>
            ...
            >
              ...
              <div className={styles.projectInfo}>
                ...
                <p className={styles.caption}>
                  {" "}
                  An example website for Replot, made in collaboration with
                  Nancy Luong. Data provided by MIT.{" "}
                </p>
              </div>
            </a>
          </div>
          ...
          <div className={styles.project}>
            ...
            >
              ...
              <div className={styles.projectInfo}>
                ...
                <p className={styles.caption}>
                  {" "}
                  My first webapp ever. A simple todo list I made that uses
                  JQuery for functionality and localStorage to keep list entries
                  across sessions.{" "}
                </p>
              </div>
            </a>
          ...
          <div className={styles.project}>
            ...
            >
              ...
              <div className={styles.projectInfo}>
                ...
                <p className={styles.caption}>
                  {" "}
                  Honorable Mention Team for M^3 <br /> AKA getting to know 3
                  others very well as you compete in a 14 hour math competition.{" "}
                </p>
              </div>
            </a>
          </div>
